...
class Launcher(QWidget):
    ...
    def setup_ui(self):
        ...
        scripts = [
            ...
            ("📊 PUND 20 V (WGFMU) - experimental", "probe_station.measurements.voltage_sweeps.IV.WGFMU.procedure_new", "#2196F3"),
            ("📊 CV Sweep Procedure (CMU)", "probe_station.measurements.voltage_sweeps.CV.procedure", "#C224BA"),
            ("📊 IV Sweep Procedure (SMU)", "probe_station.measurements.voltage_sweeps.IV.SMU.built_in_procedure", "#D1B122"),
